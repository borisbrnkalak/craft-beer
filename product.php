...
<div class="header-variant-white" id="white-menu">
      <div class="header-white">
        ...
        <div class="links">
          <ul class="nav-links">
            ...
            <li class="selected"><a href="product.php">PRODUCT</a></li>
          </ul>
    ...
    <div
      id="parallax"
      class="paralax"
      style="background-image: url('img/hero_inner_beer_06.jpg')"
    >
      <header class="header">
        <div class="logo">
        ...
        <div class="containerr">
            <div class="product-review">
                <div class="single-post">
                    ...
                    <div class="text">
                        <div class="price"><h2>13.99</h2></div>
                        <div class="name"><p>Japan blue</p></div>
                        <div class="country"><p>Japan</p></div>
