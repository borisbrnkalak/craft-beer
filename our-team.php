...
?>
      ...
      <div class="header-white">
        ...
        <div class="links">
          <ul class="nav-links">
            ...
            <li class="selected"><a href="our-team.php">OUR TEAM</a></li>
    ...
    <div
      id="parallax"
      class="paralax"
      style="background-image: url('img/Our-team/hero_inner_team.jpg')"
    >
      <header class="header">
        <div class="logo">
      ...
      <div class="paralax container">
        <div class="paralax-text">
          ...
          <span
            >Brewing is our life, beer is our water so don’t waste time drinking
